...
export default class LifecycleTestScene extends Phaser.Scene {
	constructor() {
		super();
		this.globalfuncs = new GlobalFuncs();

		var msg = "scene: scene1--function: constructor " + this.sys.settings.status
		console.log(msg)
	...
	preload() {
		var msg = "function preload: " + this.sys.settings.status
		console.log(msg)
		this.globalfuncs.tempGlobalMessages.push(msg);
	}
